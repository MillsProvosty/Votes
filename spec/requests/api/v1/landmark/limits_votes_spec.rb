...
describe "User can only vote once" do
  it "then update is called" do
    ...
    Vote.create(votable_id: 22, votable_type: "landmark", rating: 1, user_token: "12345")

    Vote.create(votable_id: 22, votable_type: "landmark", rating: 1, user_token: "9834u")
    Vote.create(votable_id: 22, votable_type: "landmark", rating: 1, user_token: "123045u")
    Vote.create(votable_id: 22, votable_type: "landmark", rating: 1, user_token: "0923nf")
    Vote.create(votable_id: 22, votable_type: "landmark", rating: -1, user_token: "re3nf")
    Vote.create(votable_id: 22, votable_type: "landmark", rating: -1, user_token: "23f3nf")
